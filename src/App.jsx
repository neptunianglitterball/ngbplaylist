          ...
          <div className="w-full space-y-10 animate-in fade-in duration-1000 font-terminal-mono">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-baseline gap-4 border-b border-[#00ff88] border-opacity-50 pb-4">
                  <div className="space-y-1 min-w-0 flex-1">
                    <p className="text-[10px] uppercase tracking-[0.3em] terminal-text-dim">TEST RESULT #NGB81</p>
                    ...
                    <div className="mt-4 flex flex-col gap-3 w-full">
                      {spotifyStatus === 'success' && spotifyPlaylistUrl ? (
                        <a
                          ...
                          style={{ borderWidth: 4 }}
                          className="w-full text-center font-terminal-mono text-sm uppercase tracking-[0.2em] border-[#00ff88] text-[#00ff88] py-2.5 hover:bg-[#00ff88] hover:text-black transition-all duration-300 active:scale-95 terminal-option"
                        >
                          OPEN IN SPOTIFY
                        </a>
                      ) : (
                        <button
                          ...
                          style={{ borderWidth: 4 }}
                          className="w-full font-terminal-mono text-sm uppercase tracking-[0.2em] border-[#00ff88] text-[#00ff88] py-2.5 hover:bg-[#00ff88] hover:text-black transition-all duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed terminal-option flex items-center justify-center gap-2"
                        >
                      ...
                      <button
                        ...
                        style={{ borderWidth: 4 }}
                        className="w-full font-terminal-mono text-sm uppercase tracking-[0.2em] border-[#00ff88] text-[#00ff88] py-2.5 hover:bg-[#00ff88] hover:text-black transition-all duration-300 active:scale-95 terminal-option"
                      >
                      ...
                      <button
                        ...
                        style={{ borderWidth: 4 }}
                        className="w-full font-terminal-mono text-sm uppercase tracking-[0.2em] border-[#00ff88] text-[#00ff88] py-2.5 hover:bg-[#00ff88] hover:text-black transition-all duration-300 active:scale-95 terminal-option flex items-center justify-center gap-2"
                      >
                        <Share2 className="w-4 h-4" /> SHARE TO STORY
                      </button>
                    </div>
                    <p className="text-[10px] terminal-text-dim uppercase tracking-wider mt-4">
            ...
            >
              <button
                ...
                style={{ borderWidth: 4 }}
                className="w-full max-w-md px-6 py-2.5 border-[#00ff88] text-[#00ff88] hover:bg-[#00ff88] hover:text-black transition-all duration-300 font-terminal-mono text-sm uppercase tracking-[0.2em] active:scale-95 terminal-option"
              >
                RETAKE THE TEST
              </button>
            </div>
